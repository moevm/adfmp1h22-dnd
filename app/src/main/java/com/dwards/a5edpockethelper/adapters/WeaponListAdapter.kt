...
class WeaponListAdapter(private var weaponArrayList: List<Weapon?>, private val listener: RecyclerViewClickListener): Adapter<WeaponListAdapter.WeaponViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WeaponViewHolder {
        val charBinding = WeaponListBinding.inflate(LayoutInflater.from(parent.context), parent, false)
