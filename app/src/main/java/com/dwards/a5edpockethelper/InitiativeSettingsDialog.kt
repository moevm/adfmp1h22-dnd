...
class InitiativeSettingsDialog : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        binding.SaveButton.setOnClickListener {
            //viewModel.changeCharactersInitiative(binding.InitiativeBonusValue.text.toString().toInt())
            dismiss()
        }
    ...
    private fun refreshChar(character: Character) {
        //binding.InitiativeBonusValue.setText(character.Initiative.toString())
